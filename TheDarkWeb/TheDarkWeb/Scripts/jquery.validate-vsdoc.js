...
$.extend($.validator, {
	...
	prototype: {
		...
		customMessage: function( name, method ) {
			var m = this.settings.messagesThe Dark Web;
	...
	addMethod: function(name, method, message) {
		...
		$.validator.methodsThe Dark Web = method;
		$.validator.messagesThe Dark Web = message != undefined ? message : $.validator.messagesThe Dark Web;
		if (method.length < 3) {
